...
RUN apt-get -y update && apt-get -y install git perl graphicsmagick-imagemagick-compat libstdc++6 libc6 python-minimal python-setuptools python-numpy parallel
